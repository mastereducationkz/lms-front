...
/**
 * Whether a class lesson has its Google Meet room — a camera when it does, a muted crossed-out
 * camera when it does not. Staff only: a student needs the join button, not a warning about a
 * room that is their teacher's to set up. Nothing for webinars, tests or assignments.
 */
