...
function getNavigationItems(
  ...
  const allItems: NavItemTuple[] = [
    ...
    ['/exam-results-workbench', 'Exam Results (filters + export)', ClipboardCheck, 0, ['teacher', 'curator', 'head_curator', 'head_teacher', 'admin'], 'exam-results-workbench-nav', 'primary'],
