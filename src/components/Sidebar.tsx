...
function getNavigationItems(
  ...
  const allItems: NavItemTuple[] = [
    ...
    ['/admin/assignment-zero', 'Assignment Zero', ClipboardCheck, 0, ['admin'], 'assignment-zero-management', 'admin'],
    ['/exam-results-tracking', 'Exam Results', ClipboardCheck, 0, ['admin', 'head_curator', 'head_teacher'], 'exam-results-tracking-nav', 'admin'],
