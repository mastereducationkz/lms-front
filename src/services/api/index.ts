...
const apiClient = {
  ...
  submitAssignment, getStudentAnswerKeys, acknowledgeAnswerKey, getMySubmissions, getPreviousHomework, getUnseenGradedCount, markSubmissionSeen,
