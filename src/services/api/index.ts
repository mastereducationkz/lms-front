...
const apiClient = {
  ...
  submitAssignment, getMySubmissions, getPreviousHomework, getUnseenGradedCount, markSubmissionSeen,
  ...
  getGroupFullAttendanceMatrix, updateLeaderboardConfig, updateAttendanceBulk, setLessonTopic,
