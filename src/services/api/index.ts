...
import { getAssignments, getAssignment, getAssignedLessonsForCourse, createAssignment, updateAssignment, submitAssignment, getStudentAnswerKeys, acknowledgeAnswerKey, releaseAnswerKey, getMySubmissions, getPreviousHomework, getUnseenGradedCount, markSubmissionSeen, getAssignmentSubmissions, getSubmission, debugSubmissions, debugDeleteSubmission, gradeSubmission, toggleAssignmentVisibility, grantExtension, getAssignmentExtensions, revokeExtension, getMyExtension, getAssignmentStatusForStudent, getAssignmentStudentProgress, allowResubmission, getPendingSubmissions, getPendingSubmissionsMeta, getRecentSubmissions, getTeacherStudentsProgress, getTeacherTodayHomework, getHeadTeacherHwGapsToday, autoGradeUnitHomework, getAutoGradeUnitHomeworkPreview, uploadAssignmentAudio, saveDraft, getDraft, getReadyToSubmit } from './assignments';
import { getAssignmentZeroStatus, getMyAssignmentZeroSubmission, saveAssignmentZeroProgress, submitAssignmentZero, uploadAssignmentZeroScreenshot, getAllAssignmentZeroSubmissions, getAssignmentZeroSubmissionByUser, revealCollegeBoardPassword, updateAssignmentZeroPlannedDate, updateAssignmentZeroExamResult, getIeltsDatePromptStatus, touchIeltsDatePrompt, getExamCountdown, getCuratorUpcomingExamResults, curatorUpdatePlannedExamDate, curatorUpdateExamResult } from './assignment-zero';
...
const apiClient = {
  ...
  submitAssignment, getStudentAnswerKeys, acknowledgeAnswerKey, releaseAnswerKey, getMySubmissions, getPreviousHomework, getUnseenGradedCount, markSubmissionSeen,
  ...
  allowResubmission, getPendingSubmissions, getPendingSubmissionsMeta, getRecentSubmissions, getTeacherStudentsProgress, getTeacherTodayHomework, getHeadTeacherHwGapsToday, autoGradeUnitHomework, getAutoGradeUnitHomeworkPreview, uploadAssignmentAudio,
  saveDraft, getDraft, getReadyToSubmit,
  // Assignment Zero
  ...
  getAllAssignmentZeroSubmissions, getAssignmentZeroSubmissionByUser, revealCollegeBoardPassword,
  updateAssignmentZeroPlannedDate, updateAssignmentZeroExamResult,
  getCuratorUpcomingExamResults, curatorUpdatePlannedExamDate, curatorUpdateExamResult,
  getIeltsDatePromptStatus, touchIeltsDatePrompt, getExamCountdown,
  // Progress
  ...
  getLessonProgressSummary, completeLessonsForTarget, resetLessonsForTarget,
  // Chat
  ...
  // Head Teacher
  getHeadTeacherManagedCourses, getHeadTeacherCourseTeachers, getHeadTeacherAttendanceGaps, getHeadTeacherHwGapsByTeacher,
