...
const apiClient = {
  ...
  allowResubmission, getPendingSubmissions, getRecentSubmissions, getTeacherStudentsProgress, autoGradeUnitHomework, getAutoGradeUnitHomeworkPreview,
  // Assignment Zero
